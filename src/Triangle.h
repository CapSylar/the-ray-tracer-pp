...
public:
    ...
    Triangle(Material *mat, Point3f p1, Point3f p2, Point3f p3) : GeometricPrimitive(mat), _p1(p1) , _p2(p2) , _p3(p3) , e1(p2 - p1), e2(p3 - p1)  , _n1(cross(e1,e2).normalize()) , isSmooth(false) {}
